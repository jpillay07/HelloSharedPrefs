...
public class MainActivity extends AppCompatActivity {
    ...
    //Reference to shared preference object and name of shared preference file created
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Restore values stored in preferences
    ...
    //Shared preference values are stored in OnPause lifecycle method
    @Override
    protected void onPause() {
        ...
        //Put the values into shared preferences with appropriate keys
        preferencesEditor.putInt(COUNT_KEY, mCount);
        preferencesEditor.putInt(COLOR_KEY, mColor);

        //Call apply() method to save. This is done asynchronously
